#!/usr/bin/env python3
"""A Flask API demonstrating Basic Auth and JWT-based authentication."""
...
app = Flask(__name__)
app.config["JWT_SECRET_KEY"] = "super-secret-key-change-me-please-32b"
...
def verify_password(username, password):
    """Check the provided credentials against the users store."""
...
def handle_needs_fresh_token_error(jwt_header, jwt_payload):
    """A fresh token is required for this action."""
